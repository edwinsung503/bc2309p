public class Maths {//Math 係一個工具
  public static void main(String[] args) {
    ...
    System.out.println(Math.sqrt(8));//2.8284271247461903<-小數
    System.out.println(Math.floor(9.9));//9.0 -> less than or equal
    ...
    System.out.println((int) Math.random()* 1000 );//0(inclusive) - 1(exclusive)
